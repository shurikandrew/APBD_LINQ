...
namespace Exercise6
{
    ...
    {
        public static IEnumerable<Emp> GetEmployeesWithSubordinates(this IEnumerable<Emp> emp)
        {
            var query =
                from e in emp
                where (from e2 in emp select e2.Mgr).Contains(e)
                orderby e.Ename ,e.Salary descending
                select e;
